      ...
      <AnimatedSection className="py-20 container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            I'm a Senior Software Engineer with extensive experience in building
            scalable, high-performance systems. With expertise in Java, Kotlin,
            Spring Boot, and blockchain technologies, I've contributed to
            several high-impact projects in the financial and distributed
            systems domains.
          </p>
